...
<form style="border:1px solid #ccc">
  <div class="container">
    ...
    <p>By creating an account you agree to our <span class="fake-link" id="privacy">Terms \& Privacy</span>
.</p>
		...
		if (data === 'success') {
			$.get("../android_connect/add_user.php", {username: usr, email: eml, password: psw1}, function(data2) {
				if (data2 === 'success') {
					let body = $('.container');
					body.empty();
					body.append($('<p>Please check your email for a link that you will need to visit to confirm your registration.</p>'));
...
$('#privacy').click(function() {
  $('.error').prop('innerHTML', "you have no privacy");
  $('.error').fadeIn(400).delay(3000).fadeOut(400);
})
